...
| Worker | Agent | Interface | HAR | Video | Auth |
|--------|-------|-----------|:---:|:-----:|------|
| `coder-acp-copilot` | GitHub Copilot CLI | ACP (subprocess) | ✅ DevProxy | ❌ | `copilot-sdk` PAT/OAuth |
| `coder-acp-claude-code` | Claude Code CLI | ACP (subprocess) | ✅ DevProxy | ❌ | `claude-code-cli` API key/OAuth |
