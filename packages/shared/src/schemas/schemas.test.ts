...
describe("request schemas", () => {
  ...
  describe("RequestResponseSchema", () => {
    ...
    it("carries the options bag when present", () => {
      const result = RequestResponseSchema.parse({ ...minimal, options: { autopilot: false } });
      expect(result.options?.autopilot).toBe(false);
    });
