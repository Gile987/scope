...
/**
 * Migration 025: Remove the legacy "post-processor" service entry.
 *
...
export class MigrateServicesToHandlerDag implements MigrationInterface {
  async up(db: Db): Promise<void> {
    ...
    console.log("[025] Deleted legacy post-processor service entry (handler registration now owned by workers)");
  }
  ...
  async down(db: Db): Promise<void> {
    ...
    console.log("[025-down] Restored legacy post-processor service entry");
  }
}
