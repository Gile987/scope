...
import type { RouteContext, ModelDocument } from "../route-context.js";

// More accurate schema for the sync endpoint's actual request body
...
export function registerModelRoutes(ctx: RouteContext): void {
  const { app, registry, modelCollection, agentCollection } = ctx;
