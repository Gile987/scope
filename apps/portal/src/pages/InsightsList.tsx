      ...
      cell: (insight) => (
        <div className="flex items-center justify-end gap-1">
          <Button
            ...
            size="icon"
            className="h-7 w-7"
            onClick={(e) => { e.stopPropagation(); upvoteMutation.mutate(insight.id); }}
          ...
          <Button
            ...
            size="icon"
            className="h-7 w-7"
            onClick={(e) => { e.stopPropagation(); downvoteMutation.mutate(insight.id); }}
          ...
          <Button
            ...
            size="icon"
            className="h-7 w-7"
            onClick={(e) => { e.stopPropagation(); blockMutation.mutate({ id: insight.id, blocked: !insight.blocked }); }}
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <DataTable
          items={pageItems}
          columns={columns}
          getRowId={(insight) => insight.id}
          activeId={activeId}
          onRowClick={(insight) =>
            navigate({ pathname: `/insights/${insight.id}/preview`, search: window.location.search })
          }
          selection={{
            selectedIds,
            onToggle: toggleRow,
