  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/codebases" element={<FeatureRoute permissions="scope/codebase:read"><CodebaseList /></FeatureRoute>} />
        <Route path="/codebases/:id" element={<FeatureRoute permissions="scope/codebase:read"><CodebaseDetail /></FeatureRoute>} />
        <Route path="/codebases/:id/revisions/:revisionId" element={<FeatureRoute permissions="scope/codebase:read"><CodebaseDetail /></FeatureRoute>} />
